...
class PoiRow implements Row {
    ...
    public List<org.modelcatalogue.spreadsheet.api.Cell> getCells() {
        if (cells == null) {
        ...
        return Collections.unmodifiableList(new ArrayList<org.modelcatalogue.spreadsheet.api.Cell>(cells.values()));
    }
    ...
    org.modelcatalogue.spreadsheet.api.Cell getCellByNumber(int oneBasedColumnNumber) {
