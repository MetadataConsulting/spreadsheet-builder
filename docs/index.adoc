...
Spreadsheet Builder API is available on Maven central and JCenter.

[source,indent=0,role="primary"]
.Gradle
----
compile 'org.modelcatalogue:spreadsheet-builder-poi:{version}'
----
...
----
<dependency>
  <groupId>org.modelcatalogue</groupId>
...
public class SpreadsheetWriter {
    ...
    public static void main(String... args) {
        ...
        PoiSpreadsheetBuilder.INSTANCE.build(w -> {                                     // <1>
            w.sheet("Sample", s -> {                                                    // <2>
                s.row(r -> {                                                            // <3>
                    r.cell("A");                                                        // <4>
                    r.cell("B");
...
You can query by sheet visibility:
